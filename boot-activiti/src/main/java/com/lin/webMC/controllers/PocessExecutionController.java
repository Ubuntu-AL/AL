...
//	private GroupOperatingInte groupOperating;
	...
	public void startProcess(@RequestBody RequestVars requestVars) {
		...
		System.out.println(requestVars.getStartSwitch().getName()+": "+requestVars.getStartSwitch().getVal());
		System.out.println(requestVars.getVars().toString());

		Map<String, String> startSwitch = new HashMap<String, String>();
		Map<String, Object> vars = new HashMap<String, Object>();
		startSwitch.put(requestVars.getStartSwitch().getName(), requestVars.getStartSwitch().getVal());
	...
	public Map<String, Object> completeUserTask(@RequestBody @RequestParam(value = "assignee") String assignee, 
										  	    @RequestBody @RequestParam(value = "taskId") String taskId, 
		...
		taskOperating.finishTask(taskService, taskId, vars);
		List<Task> tasks = taskOperating.getMyTasks(taskService, assignee);
		Map<String, Object> responseData = new HashMap<String, Object>();
		int i = 1;
...
//											    @RequestBody RequestVars requestVars){
//		if(requestVars.getVars().size() == 1) {
//			requestVars.getVars().put("default", "no-var");
//		}
//		
//		@SuppressWarnings("unchecked")
//		Map<String, String> attachmentVars = (Map<String, String>) requestVars.getVars().get("attachmentVars");
//		
//		String uploadDir = request.getSession().getServletContext().getRealPath("resource/static/annex/"+attachmentVars.get("processInstanceId")+"/"+attachmentVars.get("taskId")+"/");
//		
//		try {	
//			
//			File serverFile = new File(uploadDir+attachmentVars.get("attachmentName"));
//			
...
//		}
//		
//		String url = "Http://127.0.0.1:8080"+ uploadDir+attachmentVars.get("attachmentName");
//		attachmentVars.put("url", url);
//		taskOperating.createAttachment(taskService, attachmentVars);		
//		taskOperating.finishTask(taskService, attachmentVars.get("taskId"), requestVars.getVars());
//		
//		List<Task> tasks = taskOperating.getMyTasks(taskService, assignee);
//		Map<String, Object> responseData = new HashMap<String, Object>();
//		int i = 1;
...
//		}
//		
//		processControlOperating.performSignaltasks(runtimeService, signalId, requestVars.getVars());
//		List<Task> tasks = taskOperating.getMyTasks(taskService, assignee);
//		Map<String, Object> responseData = new HashMap<String, Object>();
//		int i = 1;
//		
...
//		}
//		
//		processControlOperating.performMessagetasks(runtimeService, messageId, requestVars.getVars());
//		List<Task> tasks = taskOperating.getMyTasks(taskService, assignee);
//		Map<String, Object> responseData = new HashMap<String, Object>();
//		int i = 1;
//		
...
//		}
//		
//		processControlOperating.performTriggertasks(runtimeService, triggerId, requestVars.getVars());
//		List<Task> tasks = taskOperating.getMyTasks(taskService, assignee);
//		Map<String, Object> responseData = new HashMap<String, Object>();
//		int i = 1;
//		
