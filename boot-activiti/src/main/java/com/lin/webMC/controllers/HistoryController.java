...
//	 * @param reqeustVars 该字典标识查询的条件，可以有多个条件
...
//		
//		for(String key : requestVars.getVars().keySet()) {
...
//			
//			queryType.put(key, requestVars.getVars().get(key));
...
//			
//			queryType.put(key, (String) requestVars.getVars().get(key));
...
//			requestVars.getVars().put("default", "no-var");
//		}
//		historyOperating.deleteHistory(historyService, requestVars.getVars());
//	}
//}
